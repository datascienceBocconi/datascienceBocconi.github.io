...
Additional references will be provided for the causal inference part of the course (see below).

### Broad structure and teaching material

The structure of the course and the teaching material is provided below.

| Topic | Teaching material | Additional material |
|-------------------------|------|------|
| **Part A. Basics** |    | |
...
| Causal inference: heterogenous treatment effects and trees     |      |      |
| Stability     |      |      |
| Prediction and uncertainty quantification     |      |      |

### Evaluation protocol

* 7/31 of the mark is on the basis of exercises 

*	15/31 of the mark is for a group project for Part B, done in groups of approx. 4. This will take the form of a hackathon managed through the Bocconi Data Science Challenges Platform. 
